...
public class CartItemAdapter extends ArrayAdapter<Food> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String formattedPrice = decimalFormat.format(cartItem.getGiaDoAn());
        txtCartItemPrice.setText(String.format(Locale.getDefault(), "Giá: %sK", formattedPrice));
