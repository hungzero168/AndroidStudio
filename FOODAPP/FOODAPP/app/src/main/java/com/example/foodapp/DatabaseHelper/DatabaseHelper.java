...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS OrderFood ('id' INTEGER PRIMARY KEY AUTOINCREMENT, 'userId' INTEGER, 'trangthai' TEXT, 'ngaydat' TEXT, 'giodat' TEXT, 'tongtien' FLOAT,  'thanhtoan' TEXT, FOREIGN KEY('userId') REFERENCES User('id'))");
    ...
    public boolean insertAcc(String taiKhoan, String matKhau) {
    ...
    public boolean updateOrderStatusAndTotalPrice(int userId, String newStatus, float newTotalPrice, String thanhtoan) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put("trangthai", newStatus);
        values.put("tongtien", newTotalPrice);
        values.put("thanhtoan", thanhtoan); // Add the payment method to the ContentValues
    ...
    public List<OrderInfo> getOrdersWithUserInfo(int userId, String status) {
        ...
        String query = "SELECT OrderFood.id, trangthai, ngaydat, giodat, tongtien, thanhtoan, " +
        ...
        while (cursor.moveToNext()) {
            ...
            String paymentMethod = cursor.getString(cursor.getColumnIndex("thanhtoan")); // Include the thanhtoan column
            ...
            OrderInfo orderInfo = new OrderInfo(orderId, orderStatus, orderDate, orderTime, totalAmount,
                     userName, userAddress, userPhoneNumber, foodDetails, orderTotal, paymentMethod);
