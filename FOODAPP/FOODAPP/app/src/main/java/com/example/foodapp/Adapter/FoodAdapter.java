...
public class FoodAdapter extends RecyclerView.Adapter<FoodAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull FoodAdapter.ViewHolder holder, int position) {
        ...
        String giaDoAnText = String.format("%.0fK", food.getGiaDoAn());
        String giaKhuyenMaiText = String.format("%.0fK", food.getGiaKhuyenMai());
        holder.GiaDoAn.setText(giaDoAnText);
        holder.GiaKhuyenMai.setText(giaKhuyenMaiText);
